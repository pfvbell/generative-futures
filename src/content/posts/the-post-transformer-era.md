...
subtitle: "3 architectures competing to replace the transformer"
description: "The transformer has become an AI bottleneck. Explore the post-transformer era: text diffusion, Continuous Thought Machines, and Nested Learning (HOPE)."
pubDate: 2026-01-05
type: essay
substackUrl: "https://genfutures.substack.com/p/the-post-transformer-era"
topics: ["how-ai-works"]
summary: "The transformer architecture, though revolutionary, has become a research bottleneck trapping AI in a local minimum — echoing co-inventor Llion Jones and Ilya Sutskever's view that scaling alone won't reach AGI. This essay surveys three emerging successors: text diffusion models that generate whole sequences at once; Continuous Thought Machines using neural synchronisation for adaptive compute; and Nested Learning (HOPE) with multi-speed memory enabling continual learning."
takeaways:
...
faqs:
  - question: "Why are transformers considered a bottleneck for AI?"
    answer: "Their success masks fundamental problems, trapping research in a local minimum. Figures like co-inventor Llion Jones and Ilya Sutskever argue scaling transformers alone cannot reach AGI."
  - question: "What are text diffusion models?"
    answer: "AI models that generate an entire text sequence simultaneously by denoising, rather than producing tokens one at a time — enabling better planning and parallelisation."
  - question: "What architectures might replace the transformer?"
    answer: "Three contenders: text diffusion models, Continuous Thought Machines, and Nested Learning (HOPE) — each addressing planning, adaptive compute, or continual learning."
entities:
  - "Llion Jones"
  - "Ilya Sutskever"
  - "Yann LeCun"
