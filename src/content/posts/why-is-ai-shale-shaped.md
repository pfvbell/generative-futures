...
faqs:
  - question: "Why is AI 'shale-shaped'?"
    answer: "Because the AI boom was made economically viable by cheap US fracked shale gas that collapsed electricity prices just as deep learning scaled — alongside GPUs and quantitative easing — not by technical inevitability."
  - question: "Are transformers the optimal AI architecture?"
    answer: "No. Transformers dominate because they align with available GPU hardware (especially after FlashAttention), creating lock-in, while alternatives like Mamba and neuromorphic chips remain underexplored."
  - question: "Does AI have to be so compute- and energy-intensive?"
    answer: "No. Neuromorphic chips can achieve comparable intelligence at roughly 1000x lower energy, and DeepSeek trained a frontier model for about $5.6M — showing that constraint breeds efficiency-focused innovation."
entities:
  - "Sarah Hooker"
  - "Albert Gu"
  - "Tri Dao"
...
keywords:
  ...
  - "AI material contingency"
  - "transformers GPU hardware lottery"
  - "shale gas AI energy"
  - "quantitative easing AI funding"
  - "sociotechnical lock-in"
  - "Mamba neuromorphic alternatives"
  - "techno-determinism AI"
---
