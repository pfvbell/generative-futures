...
pubDate: 2025-08-22
type: newsletter
substackUrl: "https://genfutures.substack.com/p/chinese-universities-embrace-ai-new"
topics: ["ai-and-geopolitics", "ai-and-work"]
summary: "The debut Tech Futures Project roundup surveys four developments revealing global divergence on AI: Chinese universities and the public embrace AI far more than Western counterparts (80% enthusiasm vs 38% UK, 25% US); tax systems lag a data-driven digital economy, prompting calls for data and capital taxes; soaring AI fundraising raises bubble fears, though tempered by real revenues; and a METR study finds experienced developers work ~19% slower with AI tools."
takeaways:
  - "AI enthusiasm diverges sharply by country (China 80%, UK 38%, US 25%), with Chinese universities deploying rather than resisting AI."
  - "A METR study found experienced developers were ~19% slower using AI tools on familiar tasks."
  - "Data-driven digital economies escape traditional tax frameworks, motivating proposals for data and capital taxes."
  - "AI may be a bubble, but unlike the dot-com era major labs generate real revenue and profit."
...
faqs:
  ...
  - question: "Is AI in a financial bubble?"
    answer: "There are bubble-like signs in fundraising, but unlike the dot-com boom leading AI labs generate substantial real revenues, which tempers the comparison."
entities:
  - "METR"
  - "Stanford HAI"
