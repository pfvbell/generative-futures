---
title: "The radicalism of Positive Alignment"
subtitle: "Could it go further?"
description: "Positive Alignment makes human flourishing a technical target for AI, breaking from RLHF's revealed-preference logic. Radical, but does it go far enough?"
pubDate: 2026-06-03
type: essay
featured: true
substackUrl: "https://genfutures.substack.com/p/the-radicalism-of-positive-alignment"
topics: ["ai-safety-and-alignment", "political-economy-of-ai"]
summary: "A close reading of 'Positive Alignment', a proposal from researchers at DeepMind, OpenAI, Anthropic and Oxford to make human flourishing an explicit technical objective across the AI lifecycle, rather than optimising for short-term revealed preferences as RLHF does. The essay praises its multi-dimensional model of the good life but argues it remains politically naive: its reliance on market 'alignment-as-a-service' contradicts its own critique, and it lacks a theory of change."
takeaways:
...
faqs:
  - question: "What is Positive Alignment in AI?"
    answer: "It is an approach that makes human flourishing an explicit technical objective integrated across the whole AI lifecycle, rather than optimising for users' short-term revealed preferences as RLHF does."
  - question: "What's wrong with RLHF for AI alignment?"
    answer: "RLHF compresses human feedback into a single scalar reward via the Bradley-Terry model, structurally privileging immediate revealed preferences over long-term wellbeing, echoing flawed assumptions from economics and social-media design."
  - question: "Why might Positive Alignment fall short?"
    answer: "Its governance proposal relies on market-based 'alignment-as-a-service', which contradicts its own critique of revealed preferences, and it lacks the political analysis and theory of change needed for real adoption."
entities:
  - "Amartya Sen"
  - "Elinor Ostrom"
  - "Nir Eyal"
